...
cd suricata-1.3
./configure --enable-profiling --prefix=/opt/suricata13/ --with-libnss-includes=/usr/include/nss --with-libnss-libs=/usr/lib/nss --with-libnspr-includes=/usr/include/nspr --with-libnspr-libraries=/usr/lib/nspr && make  && sudo make install
...
make distclean
./configure LD_RUN_PATH="/opt/pcre-8.30/lib:/usr/lib:/usr/local/lib" --enable-pcre-jit --with-libpcre-libraries=/opt/pcre-8.30/lib/ --with-libpcre-includes=/opt/pcre-8.30/include/ --enable-profiling --prefix=/opt/suricata13JIT/ --with-libnss-includes=/usr/include/nss --with-libnss-libs=/usr/lib/nss --with-libnspr-includes=/usr/include/nspr --with-libnspr-libraries=/usr/lib/nspr && make && sudo make install
