...
sudo cp ../ppconfigs/pp-suricata-1.3b2-ETOPEN.config /opt/suricata13b2/etc/etopen/
sudo cp ../ppconfigs/pp-suricata-1.3b2JIT-ETOPEN.config /opt/suricata13b2JIT/etc/etopen/
cd ..
